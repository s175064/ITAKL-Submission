function [ elevation2 ] = get_elevation_fuct(angle1_deg, angle2_deg, rows, cols, center1, center2, radius)
...
elevation(91, :, :) = filled_matrix_elevation;
elevation2 = elevation; 
%end;
%hdr = spm_vol('/project/radiology/ANSIR_lab/shared/s175064_workspace/HS_multicontrast_final/MNI152_T1_1mm.nii');
...
for a=1:720
    elevation2 = elevation2 + imrotate3(elevation, a*0.5, [0 0 1], 'linear', 'crop');
end 
elevation2(elevation2>0) = 1; 
